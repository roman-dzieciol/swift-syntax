...
/// MARK: Syntax Node Creation APIs
  ...
  public static func makeCustomAttribute(atSignToken: TokenSyntax, attributeName: TypeSyntax, leftParen: TokenSyntax?, argumentList: FunctionCallArgumentListSyntax?, rightParen: TokenSyntax?) -> CustomAttributeSyntax {
    let layout: [RawSyntax?] = [
      atSignToken.raw,
      attributeName.raw,
      leftParen?.raw,
